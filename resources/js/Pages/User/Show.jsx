...
export default function Show({ user, tasks, queryParams }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">{`User "${user.name}"`}</h2>}
        >
                            ...
                            <div className="grid gap-1 grid-cols-2 mt-2" >
                                <div className="p-3 rounded-b-lg bg-gray-800 text-gray-200">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1">
                                            <span className={' px-3 py-1 rounded text-white ' + USER_STATUS_CLASS_MAP[user.status]}>
