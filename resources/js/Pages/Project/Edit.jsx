        ...
        <AuthenticatedLayout
            header={
                <div className='flex justify-between items-center' >
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit Projects "{project.name}"</h2>
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                            <form
                                ...
                                {project.image_path && <div className="mb-4 flex items-center justify-center">
                                    <img src={project.image_path} className="w-64 rounded" />
                                </div>}
                                <div className="mt-4">
