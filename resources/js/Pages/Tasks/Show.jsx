                            ...
                            <div className="grid gap-1 grid-cols-2 mt-2" >
                                <div className="p-3 rounded-b-lg bg-gray-800 text-gray-200">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1">
                                            <span className={' px-3 py-1 rounded text-white ' + TASK_PRIORITY_CLASS_MAP[task.priority]}>
                                ...
                                <div className="p-3 rounded-b-lg bg-gray-800 text-gray-200">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <p className="mt-1">
                                            <Link className='text-gray-100 hover:underline' href={route('project.show', task.project.id)} >
                                                {task.project.name}
                                            </Link>
                                        </p>
                                    </div>
